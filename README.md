...
# Magellan Mission Dictionary
<!-- EXAMPLES
   Spectral (sp:) Discipline Dictionary
   DART Mission (dart:) Local Dictionary
-->

The Magellan mission dictionary provides classes and attributes specific to the Magellan mission and its instruments.
...
are located at https://pds-data-dictionaries.github.io/ldd-mgn (TBD).
<!-- EXAMPLE
...
-->     
* Download dictionary files from [MGN](https://pds.nasa.gov/datastandards/dictionaries/#mgn)
